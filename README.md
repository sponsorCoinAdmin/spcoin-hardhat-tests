...
2. Running the test menu display, <b>'tm'</b>, command will list the testing options.
   ...
   Running the alias menu command <b>'runtest'</b> will start the [<b>spHardHatSwap</b>](https://github.com/sponsorCoinAdmin/spCoinHatdHatTests/tree/main) application.
 - - - -
